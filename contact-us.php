...
together!</p>
                ...
                <div class="col-lg-6 mt-4 mt-lg-0 p-xl-0">
                    <div class="pq-form-div border-0 mt-0">
                        ...
                        <form action="backend" method="post" class="pq-applyform">
                            <div class="row">
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <textarea cols="40" rows="10" name="message" placeholder="Message"></textarea>
                                </div>
                                <div class="col-lg-12">
                                    <button type="submit" class="pq-button click-button">SUBMIT</button>
                                </div>
                            </div>
                        </form>
                    </div>
